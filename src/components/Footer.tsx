            ...
            <div className='flex flex-col gap-3 justify-center items-center'>
                ...
                <div className='flex flex-col justify-center gap-2'>
                    ...
                    <div className='flex flex-row-reverse gap-2'>
                        ...
                        <FaLocationDot className='text-white text-[14px] sm:text-[16px]' />
                    </div>
                    <p className='text-white font-semibold text-[12px] sm:text-[14px]'>
                        اتصل بنا
                    </p>

                    <div className='flex flex-row justify-center gap-3'>
                        <div className='flex flex-row gap-1'>
                            <p className='text-white text-[10px] sm:text-[12px]'>(555) 123-4567</p>
                            <BsTelephone className='text-white text-[14px] sm:text-[16px]' />
                        </div>
                        <div className='flex flex-row gap-2'>
                            <p className='text-white text-[10px] sm:text-[12px]'>contact@creativeideas.com</p>
                            <FiMail className='text-white text-[14px] sm:text-[16px]' />
                        </div>
                    </div>
