...
export default function HomePage() {
    ...
    return (
        <>
            ...
            <main>
                {/* Header*/}
                <section className="relative w-full min-h-[90vh] md:min-h-[85vh] overflow-hidden" style={{ backgroundImage: "url('/previuosUnitbg.png')", backgroundRepeat: "no-repeat", backgroundSize: "cover" }}>
